...
- [#2777](https://github.com/JedWatson/react-select-legacy/pull/2777) pass entire event to `shouldKeyDownEventCreateNewOption`
- Fix to [#2764](https://github.com/JedWatson/react-select-legacy/issues/2764) [#2775](https://github.com/JedWatson/react-select-legacy/pull/2775) fix html compliance
- [#1436](https://github.com/JedWatson/react-select-legacy/pull/1436) Add option to show new creatable item as first or last option. [Stenerson](https://github.com/Stenerson)
- Fix to [#2239](https://github.com/JedWatson/react-select-legacy/issues/2239), [#2314](https://github.com/JedWatson/react-select-legacy/pull/2314). Thanks [ytiurin](https://github.com/ytiurin)
- Use template literals in favor of string concatenation. [#2325](https://github.com/JedWatson/react-select-legacy/pull/2325/files)
- Add values to ValuesComponent in multi-select [#2362](https://github.com/JedWatson/react-select-legacy/pull/2362), thanks [misantronic](https://github.com/misantronic)
- [#2376](https://github.com/JedWatson/react-select-legacy/pull/2376) Selected disabled items are now flagged with CSS class, thanks [wijnbladh](https://github.com/JedWatson/wijnbladh)
- [#2465](https://github.com/JedWatson/react-select-legacy/pull/2465) Remain focused on option after selecting, thanks [tpbowden](https://github.com/tpbowden)
- [#2736](https://github.com/JedWatson/react-select-legacy/pull/2736), FocusedOption now cleared on open of the menu. thanks [jmatth](https://github.com/jmatth)
- [#2704](https://github.com/JedWatson/react-select-legacy/pull/2704), fix to [#1620](https://github.com/JedWatson/react-select-legacy/issues/1620). Thanks [sumthief](https://github.com/sumthief)

## v1.2.1 / 2018-01-13

- Fixed blocking the Del key when deleteRemoves is false, thanks [Nachtigall, Jens (init)](https://github.com/jnachtigall) - [see PR](https://github.com/JedWatson/react-select-legacy/pull/2291)
- Fixed inline-block rendering for arrowRenderer without autosize, thanks [Harry Kao](https://github.com/harrykao) - [see PR](https://github.com/JedWatson/react-select-legacy/pull/2276)
- Fixed dropdown menu positioning issues in IE 11, thanks [jharris4](https://github.com/jharris4) - [see PR](https://github.com/JedWatson/react-select-legacy/pull/2273)
- Added missing rule to the `scss` stylesheet, thanks [Jordan Whitfield](https://github.com/mantissa7) - [see PR](https://github.com/JedWatson/react-select-legacy/pull/2280)

## v1.2.0 / 2018-01-08

- Source cleanup, thanks to [Yuri S](https://github.com/yuri-sakharov) and
  [Charles Lee](https://github.com/gwyneplaine) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2262)
- Switched from babel-preset-es2015 to babel-preset-env, thanks
  [Rambabu Yadlapalli](https://github.com/RamYadlapalli) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2254)
- Fixed focused option. Issue #2237, thanks
  [Yuri S](https://github.com/yuri-sakharov) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2245)
- Fix onSelectResetsInput bug from keyboard navigation, thanks
  [Charles Lee](https://github.com/gwyneplaine) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2259)
- Fixed all warnings on running tests, thanks
  [Yuri S](https://github.com/yuri-sakharov) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2231)
- Added missing tests for Option.js and refactored Option-test.js., thanks
  [Yuri S](https://github.com/yuri-sakharov) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2249)
- Added missing tests for Async.js, thanks
  [Yuri S](https://github.com/yuri-sakharov) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2250)
- Fixed console error in GitHub users example, thanks
  [Yuri S](https://github.com/yuri-sakharov) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2244)
- Fixed readme example. Issue #2235, thanks
  [Yuri S](https://github.com/yuri-sakharov) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2246)
- Regression fix for single select with onSelectResetsInput=false, thanks
  [Yuri S](https://github.com/yuri-sakharov) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2226)
- Pass placeholder prop to ValueComponent, thanks
  [Aravind Srivatsan](https://github.com/aravindsrivats) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2225)
- Refactored handleKeyDown switch, thanks
  [Yuri S](https://github.com/yuri-sakharov) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2228)
- onSelectResetsInput regression fixed, thanks
  [Jed Watson](https://github.com/dehamilton) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2215)
- Don't open drop down menu when clear values, thanks
  [Jed Watson](https://github.com/Chopinsky) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2198)
- Clear input value on receiving props with another value., thanks
  [Yuri S](https://github.com/yuri-sakharov) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2183)
- Fix/is option unique crash, thanks [Jacob Zuo](https://github.com/Chopinsky) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2185)
- Use react-input-autosize v2.1.2 for guard against undefined window, thanks
  [DStyleZ](https://github.com/sximba) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2187)
- Fix issue #2182, thanks [Kurt Hoyt](https://github.com/kurtinatlanta) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2213)
- Documenting behavior of onBlurResetsInput in the readme., thanks
  [hobbsl](https://github.com/levininja) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2212)
- Use onSelectResetsInput for single select, thanks
  [lachiet](https://github.com/lachiet) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2205)
- Fix state value in README example, thanks
  [Srishan Bhattarai](https://github.com/srishanbhattarai) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2192)
- document breaking change of removing getInputValue, thanks
  [Turadg Aleahmad](https://github.com/turadg) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2195)
- Fixed search for invalid label and/or value, thanks
  [Yuri S](https://github.com/yuri-sakharov) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2179)
...
- breaking; removed `getInputValue` function -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2108)
- reverted spacebar-selects-option behaviour for searchable selects, thanks
  [Charles Lee](https://github.com/gwyneplaine) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2163)
- fixed behaviour where async doesn't handle onInputChange returning a value,
  thanks [Anton](https://github.com/tehbi4) -
  [see PR](https://github.com/JedWatson/react-select-legacy/pull/2133)
...
- updated; `react-input-autosize@2.0.0` including several fixes for react-select-legacy
  (see
...
- fixed; re-added fix to
  [#1580](https://github.com/JedWatson/react-select-legacy/issues/1580), thanks
  [agirton](https://github.com/agirton)
...
- breaking change; Custom `Option` components now need to pass their `option`
  ...
  [this commit](https://github.com/JedWatson/react-select-legacy/commit/89af12a80a972794222b193a767f44234bbe9817)
...
continue to use `react-select-legacy@0.6.x`. There are no functional differences
between v0.7.0 and v0.6.12.

Additionally, our tests now require Node.js 4.x. If you are developing
`react-select-legacy`, please make sure you are running the latest version of node.
...
- improved; option, value and single value have been split out into their own
  ...
  [#328](https://github.com/JedWatson/react-select-legacy/pull/328) for more details.
...
- fixed; `react-input-autosize` now correctly escapes ampersands (&), not
  actually a fix in react-select-legacy but worth noting here because it would have
  been causing a problem in `react-select-legacy` as well.
...
- added; `onOptionLabelClick` prop - see
  [#66](https://github.com/JedWatson/react-select-legacy/pull/66) for docs, thanks
