...
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; /*!
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                http://jedwatson.github.io/react-select-legacy
                                                                                                                                                                                                                                                                              */
...
var Select = function (_React$Component) {
	...
	function Select(props) {
		...
		["clearValue", "focusOption", "getOptionLabel", "handleInputBlur", "handleInputChange", "handleInputFocus", "handleInputValueChange", "handleKeyDown", "handleMenuScroll", "handleMouseDown", "handleMouseDownOnArrow", "handleMouseDownOnMenu", "handleTouchEnd", "handleTouchEndClearValue", "handleTouchMove", "handleTouchOutside", "handleTouchStart", "handleValueClick", "onOptionRef", "removeValue", "selectValue", "handleMouseClickOutside"].forEach(function (fn) {
	...
	_createClass(Select, [{
		...
		value: function componentWillMount() {
			this._instancePrefix = "react-select-legacy-" + (this.props.instanceId || ++instanceId) + "-";
		...
		value: function componentDidMount() {
			if (typeof this.props.autofocus !== "undefined" && typeof console !== "undefined") {
				console.warn("Warning: The autofocus prop has changed to autoFocus, support will be removed after react-select-legacy@1.0");
			}
   ...
   */
		...
		value: function renderInput(valueArray, focusedOptionIndex) {
			...
			if (this.props.autosize) {
				return _react2.default.createElement(_reactInputAutosize2.default, _extends({
					id: this.props.id
				}, inputProps, {
					className: className,
					minWidth: "5"
...
Select.propTypes = {
	...
	rtl: _propTypes2.default.bool, // set to true in order to use react-select-legacy in right-to-left direction
